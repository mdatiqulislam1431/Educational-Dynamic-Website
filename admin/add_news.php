                ...
                <div class="col-lg-12">
                    <div class="breadcome-list map-mg-t-40-gl shadow-reset">
                        ...
                        <ul class="breadcome-menu">
                            ...
                            <li><span class="bread-blod">add news</span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="sparkline8-list shadow-reset">
                        <div class="sparkline8-hd">
                            <div class="main-sparkline8-hd">
                                <h1><mark style="background-color: blue; color: white;">Add news</mark></h1> 
         ...
         if ($_SERVER ['REQUEST_METHOD'] == 'POST') {
            ...
            $uploaded_image = "uploads/".$unique_image;
                 ...
                 echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
                    ...
                    $query="INSERT INTO  tbl_news(title, dat, content, image, category) VALUES('$title', '$dat', '$content', '$uploaded_image', '$category')";

                      $news_upload = $db->insert($query);

                      if ($news_upload) {
                          $m="News info uploaded successfully!";
                      }else{
                          $n="News info not uploaded! try again.";
                      }
                 }
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group text-left">
                                ...
                                <select name="category" class="form-control">
                                    ...
                                    <option value="news_one">news_one</option>
                                    <option value="news_two">news_two</option>
                                </select>
                            </div>
