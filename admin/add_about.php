                ...
                <div class="col-lg-12">
                    <div class="breadcome-list map-mg-t-40-gl shadow-reset">
                        ...
                        <ul class="breadcome-menu">
                            ...
                            <li><span class="bread-blod">Add about</span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="sparkline8-list shadow-reset">
                        <div class="sparkline8-hd">
                            <div class="main-sparkline8-hd">
                                <h1><mark style="background-color: blue; color: white;">Add About</mark></h1>
            ...
            if ($_SERVER ['REQUEST_METHOD'] == 'POST') {
                ...
                $content =mysqli_real_escape_string($db->link, $_POST['content']);
                 ...
                 if ($title== "") {
                    ...
                    $query="INSERT INTO  tbl_about(title, sub_title, content) VALUES('$title', '$sub_title', '$content')";

                      $about_us = $db->insert($query);

                      if ($about_us) {
                          $m="about_us info uploaded successfully!";
                      }else{
                          $n="about_us info not uploaded! try again.";
                      }
                 }
