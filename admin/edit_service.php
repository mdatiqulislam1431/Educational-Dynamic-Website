                    ...
                    <div class="sparkline8-list shadow-reset">
                        <div class="sparkline8-hd">
                            <div class="main-sparkline8-hd">
                                <h1><mark style="background-color: blue; color: white;">Edit Service</mark></h1>
            ...
            $uploaded_image = "uploads/".$unique_image;
                 ...
                 echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
                    ...
                    $query="UPDATE  tbl_services
                      ...
                      $service_update = $db->update($query);

                      if ($service_update) {
                          $m="Service info uploaded successfully!";
                      }else{
                          $n="Service info not uploaded! try again.";
                      }
                 }
...
<?php
        $query="SELECT * FROM tbl_services where id='$id'";
         $edit_service=$db->select($query);
          if ($edit_service) {
              $result=$edit_service->fetch_assoc()
