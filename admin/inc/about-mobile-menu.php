            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                        ...
                        <li class="active"><a data-toggle="tab" href="#mailbox">About</a>
                        </li>
                        <li><a data-toggle="tab" href="#Interface">Services</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="mailbox" class="tab-pane active tab-custon-menu-bg animated flipInX">
                            <ul class="main-menu-dropdown">
                        ...
                        <div id="Interface" class="tab-pane tab-custon-menu-bg animated flipInX">
                            <ul class="main-menu-dropdown">
                                ...
                                <li><a href="service_offers_list.php">Offer List</a></li>
                                <li><a href="add-bottom-offer.php">Add Offer bottom</a></li>
