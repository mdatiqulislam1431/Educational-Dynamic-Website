                    ...
                    <div class="sparkline8-list shadow-reset">
                        <div class="sparkline8-hd">
                            <div class="main-sparkline8-hd">
                                <h1><mark style="background-color: blue; color: white;">Add Course</mark></h1>
...
<div class="product-tab-list tab-pane fade active in" id="description">
    <div class="row">
        ...
        <?php 
            ...
            if ($_SERVER ['REQUEST_METHOD'] == 'POST') {
                ...
                $course_column =mysqli_real_escape_string($db->link, $_POST['course_column']);
                 ...
                 }elseif ($course_column == "") {
                     $n="You didn't field course_column field";
                 }else{

                        
                    $query="UPDATE tbl_design
                            SET
                           title = '$title', 
                           content = '$content', 
                      ...
                      $course_update = $db->update($query);

                      if ($course_update) {
                          $m="Course info update successfully!";
                      }else{
                          $n="Course info not update! try again.";
                      }
                 }
    ...
    <?php 
            $query="SELECT * FROM tbl_design where id='$id'";
              $edit_design=$db->select($query);
                if ($edit_design) {
                     $result=$edit_design->fetch_assoc()
    ...
    ?>
            <p style="text-align: center;color: #cc0101;letter-spacing: 2px;"><?php echo $n; ?></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group text-left">
                                <label>Course column:</label>
                                <select name="course_column" class="form-control">

                                    <option value="<?php echo $result['course_column']; ?>"><?php echo $result['course_column']; ?></option>
