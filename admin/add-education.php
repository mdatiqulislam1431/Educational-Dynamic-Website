                ...
                <div class="col-lg-12">
                    <div class="breadcome-list map-mg-t-40-gl shadow-reset">
                        ...
                        <ul class="breadcome-menu">
                            ...
                            <li><span class="bread-blod">add education</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            if ($_SERVER ['REQUEST_METHOD'] == 'POST') {
                ...
                $course_column =mysqli_real_escape_string($db->link, $_POST['course_column']);
                 ...
                 if ($title== "") {
                    ...
                    $query="INSERT INTO  tbl_design(title, content, course_column) VALUES('$title', '$content', '$course_column')";
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group text-left">
                                ...
                                <select name="course_column" class="form-control">
                                    ...
                                    <option value="colum_1">colum_1</option>
                                    <option value="colum_2">colum_2</option>
                                    <option value="colum_3">colum_3</option>
