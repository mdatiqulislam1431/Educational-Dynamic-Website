                ...
                <div class="col-lg-12">
                    <div class="breadcome-list map-mg-t-40-gl shadow-reset">
                        ...
                        <ul class="breadcome-menu">
                            ...
                            <li><span class="bread-blod">Edit Welcome</span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="sparkline8-list shadow-reset">
                        <div class="sparkline8-hd">
                            <div class="main-sparkline8-hd">
                                <h1><mark style="background-color: blue; color: white;">Edit Welcome</mark></h1>
...
<div class="product-tab-list tab-pane fade active in" id="description">
                ...
                $content =mysqli_real_escape_string($db->link, $_POST['content']);
                 ...
                 if ($title== "") {
                    ...
                    $query="UPDATE tbl_welcome
                      ...
                      $welcome_update = $db->update($query);

                      if ($welcome_update) {
                          $m="welcome_ed info update successfully!";
                      }else{
                          $n="welcome_ed info not update! try again.";
                      }
                 }
    ...
    <?php 
        $query="SELECT * FROM tbl_welcome where id='$id'";
          $welcome_update=$db->select($query);
            if ($welcome_update) {
                 $result=$welcome_update->fetch_assoc()
