                    ...
                    <div class="sparkline8-list shadow-reset">
                        <div class="sparkline8-hd">
                            <div class="main-sparkline8-hd">
                                <h1><mark style="background-color: blue; color: white;">News list</mark></h1> 
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $fm->textShorten($result['dat'],20); ?></td>
      ...
      <td><a style="color: green;" target="_blank" href="edit_news.php?edit_id=<?php echo $result['id']; ?>">Edit</a>
       ||
        <a style="color: red;" onclick="return confirm('Ary you sure Delete This!');" href="delete_news.php?del_id=<?php echo $result['id']; ?>" >Delete</a></td>
    </tr>
  </tbody>
<?php } } ?>
